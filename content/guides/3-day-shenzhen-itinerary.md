...
1. **Sort your entry.** Most Western passports now get 30 days visa-free; others can use the [240-hour visa-free transit](/guides/china-240-hour-visa-free-transit). Coming from Hong Kong? Read the [border crossing guide](/guides/hong-kong-to-shenzhen) — choose your crossing based on where you're staying.
2. **Install an eSIM before you cross.** Google, WhatsApp, and Instagram don't work on Chinese networks without one (or a VPN). A [travel eSIM](/guides/best-esim-for-shenzhen) routes around this automatically.
3. **Set up Alipay with your foreign card.** Cash is awkward here and foreign cards rarely work in person. [Ten minutes of setup](/guides/alipay-wechat-pay-setup) fixes this completely.
4. **Book a central hotel.** Stay in Futian unless you have a reason not to — here's the [full area breakdown](/guides/where-to-stay-in-shenzhen).
...
**Afternoon: Huaqiangbei.** Two metro stops away is the world's largest electronics market district. Even if you have zero intention of buying anything, walk through SEG Plaza's component floors — counters of chips, capacitors, drone parts, and LED panels stacked ten floors high. If you DO want to buy something, read the [Huaqiangbei guide](/guides/huaqiangbei-electronics-guide) first so you don't overpay.
...
**Evening: stay for sunset on the bay**, then take the metro back via Line 11 (15 minutes to Futian). Getting around all day is trivially easy with the [metro](/guides/shenzhen-metro-guide); use [DiDi](/guides/didi-shenzhen-guide) for the few gaps.
